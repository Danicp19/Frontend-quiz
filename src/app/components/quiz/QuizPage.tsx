    ...
    return (
        <div className="grid grid-cols-2 gap-x-24 gap-y-12 desktop:grid-cols-1 desktop:gap-x-0">
            <div className="flex flex-col gap-11 desktop:pb-12 mobile:gap-5 mobile:pb-4">
                ...
                <div
                    className={`relative mt-auto h-6 w-full rounded-full p-2 transition-all duration-300 before:absolute before:top-1/4 before:h-3 before:w-3/4 before:rounded-full before:bg-purple desktop:before:w-1/2 mobile:before:w-1/4 ${darkMode ? "bg-navy" : "bg-white"
                        }`}
                ></div>
            </div>
